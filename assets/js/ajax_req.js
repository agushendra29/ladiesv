$("#editCatForm").submit((function (e) {
    ...
    e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_cat.php", {
        delete_id: $delete_id,
    ...
    $.ajax({
        ...
        data: t,
        success: function (e) {
            "yes" == $.trim(e) ? (alert("member added successfully"), location.reload()) : alert(e)
        }
    })
    ...
    e.preventDefault(), $delete_id = $(this).data("id"), confirm("Are You sure want to delete this item?") && $.post("app/action/delete_stock_management.php", {
        delete_id: $delete_id,
        delete_data: "delete_data"
    }, (function (e) {
        "true" == e ? (alert("data deleted successfull"), location.reload()) : alert(e)
