<div class="" style="padding:50px; max-width:900px; margin:auto;">
  <h2 style="font-size:28px; font-weight:700; color:#1e293b; margin-bottom:32px;">
  ...
  <div style="display:flex; gap:20px; margin-bottom:20px;">
    ...
    <div style="display:flex; align-items:flex-end;">
      <button type="button" id="addChildBtn" 
              style="padding:12px 24px; background-color:#2563eb; color:white; border:none; border-radius:12px; cursor:pointer; font-weight:600;">
        Add
      </button>
    </div>
  </div>

  <table id="childDistributorTable" style="width:100%; border-collapse: collapse; font-size:14px;">
    <thead>
      <tr>
  ...
  <button type="button" id="saveBtn" 
          style="margin-top:20px; padding:12px 32px; background-color:#16a34a; color:white; border:none; border-radius:12px; font-weight:600; cursor:pointer;">
    Simpan Semua
  </button>
</div>
