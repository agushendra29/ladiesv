...
{
  $sql = "
      SELECT suppliar_code AS code, name FROM suppliar WHERE id = ?
  ";
  ...
  return "Tidak ada referal Code";
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px; margin-bottom: 30px; font-size: 15px; line-height: 1.6;">
      ...
      <div><label style="font-weight: bold;">NPWP:</label><br><?= htmlspecialchars($data->npwp ? $data->npwp : "-") ?></div>
      ...
      <div><label style="font-weight: bold;">Status:</label><br>
        <?php 
