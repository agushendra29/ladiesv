        ...
        <form id="addNews">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="date" class="form-control" id="publish_date" name="publish_date" style="border-radius: 8px;" required>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control" id="content" name="content" rows="6" placeholder="Tulis isi berita di sini..." style="border-radius: 8px;" required></textarea>
            </div>
          </div>
          ...
          <div class="row mt-4">
            <div class="col-md-6 offset-md-3 text-center">
              ...
              <button type="submit" style="
                ...
                onmouseout="this.style.backgroundColor='#0073ea'">Simpan Berita</button>
            </div>
          </div>
        </form>
      </div>
