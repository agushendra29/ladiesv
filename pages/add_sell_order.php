<div>
  ...
  <section class="content">
    <div class="mt-5">
      ...
      <form id="salesForm">
        <div class="row gx-4 gy-3" style="margin-bottom:20px;row-gap:25px;">

          <!-- Produk -->
          <div class="col-md-6">
            <label for="product_id" style="font-weight: 500; display: block; margin-bottom: 8px;">Produk *</label>
          ...
          <!-- Kuantitas -->
          <div class="col-md-6">
            <label for="quantity" style="font-weight: 500; display: block; margin-bottom: 8px;">Kuantitas *</label>
