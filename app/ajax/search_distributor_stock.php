...
// 2️⃣ Ambil data penjualan dari transaction_histories
$sql = "
SELECT 
    s.suppliar_code,
...
WHERE 
    t.type = 'penjualan'
    AND t.is_refund = 0
    AND t.suppliar_role_id = 3
    AND t.suppliar_parent_id = ?
    AND DATE(t.created_at) BETWEEN ? AND ?
";

// 3️⃣ Filter produk kalau ada
...
$sql .= " GROUP BY s.suppliar_code, s.name, p.product_name
